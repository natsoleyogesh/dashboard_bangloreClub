...
const AddDownload = () => {
    ...
    const validateForm = () => {
        ...
        if (!downloadData.title) validationErrors.title = "Title is required.";
        if (!downloadData.expiredDate) {
            validationErrors.expiredDate = "Expiration date is required.";
        } else if (new Date(downloadData.expiredDate) < new Date()) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await addDownload(formData);
            ...
            >
                ...
                <Box sx={{ mb: 2 }}>
                    ...
                    <TextField
                        ...
                        fullWidth
                        name="expiredDate"
                        value={downloadData.expiredDate}
                        onChange={handleInputChange}
